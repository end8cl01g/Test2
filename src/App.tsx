  ...
  return (
    ...
    >
      ...
      <main className="relative z-10 flex-1 flex flex-col items-center justify-start pb-36 pt-2">
        {activeTab === 'scrolls' && <div className="w-full animate-fade-in"><ParchmentScroll onWorkoutLogged={refresh} /></div>}
        ...
        {activeTab === 'perks' && (
          <div className="w-full animate-fade-in">
            <SkyrimSkills
              trees={trees}
              perkPoints={stats.ready ? stats.points.available : 3}
              initialUnlocked={stats.unlocked}
              playerXP={stats.totalXP}
              playerStreak={stats.streak}
              onPerkUnlocked={refresh}
            />
          </div>
        )}
      </main>
